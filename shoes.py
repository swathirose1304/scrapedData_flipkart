...
# df = pd.DataFrame({'ProductName':product_name_lst, 'RealPrice':real_price_lst, 'Offer':offer_percent_lst, 'OfferPrice':offer_prices_lst})
# print(df)
...
# worksheet = workbook.create_sheet('shoes')
